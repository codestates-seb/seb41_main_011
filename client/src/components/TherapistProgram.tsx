...
import { therapistProgramListProps } from '../types';
...
const TherapistProgram = (props: therapistProgramListProps) => {
  const programInfo = props.item;

  return (
    <Contents>
      <Link to={`/myprogram/${programInfo.programId}`}>
        ...
        <div className='flex-row'>
          <div className='info'>
            <strong>정원</strong>
            {programInfo.userCount}/{programInfo.userMax}
          </div>
        </div>
      </Link>
    </Contents>
