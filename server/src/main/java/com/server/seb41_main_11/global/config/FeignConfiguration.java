package com.server.seb41_main_11.global.config;

import com.server.seb41_main_11.global.error.FeignClientExceptionErrorDecoder;
import feign.Logger;
 ...
 */
@Configuration
@EnableFeignClients(basePackages = "com.server.seb41_main_11") // todo 패키지명 수정
